...
export const api = {
  ...
  createPayrollRun: (data: { title?: string; period_start: string; period_end: string; venue_id?: string; notes?: string }) => request<PayrollRun>('/api/payroll-runs', { method: 'POST', body: JSON.stringify(data) }),
